...
;; Marked batches, a single object, and a whole prefix.  Deletion is the one
;; operation here that can destroy an unbounded amount of data, so the recursive
;; form demands a typed `yes' and a dry run is available first.
